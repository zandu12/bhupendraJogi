...
Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/Personal",
"root","root");
Statement stmt=con.createStatement();
PreparedStatement pstm=con.prepareStatement("insert into Personal values(?,?,?,?)");
PreparedStatement pstm1=con.prepareStatement("delete from Personal wheresno=?");
